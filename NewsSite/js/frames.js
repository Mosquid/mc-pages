...
function show_popup() {
	...
	window.open('http://macedonia-timeless.com', 'title', 'toolbar=no, location=no, directories=no, status=no, menubar=no, resizable=no, width='+screen_w+', height='+screen_h+', top='+top+', left='+left+'');
