...
$(document).ready(function() {
    ...
    $('body.beforeplay').on('touchend', '.jp-play', function() {
    ...
    if( $('#header-slider').length ) {
        $('#header-slider').flexslider({
            slideshowSpeed: 5000,
            manualControls: '.header-slider-thumbs .slide-thumbs li',
            directionNav: false,
            controlNav: true
        });
    }
    ...
    $('#content .content-row .posts-group').each(function() {
        $(this).find('article.post').matchHeight();
    });

    if( $('.posts-list').length ) {
        $('.posts-list .post h3.post-title, .recommended-posts .post .post-title').matchHeight();
    }
});
    ...
    $('.jquery_jplayer_wrap').each(function(){
        ...
        $(this).jPlayer({
            ready: function () {
                ...
                if( $(this).parents('.jpg_modal').find('.preloader') ) {
                    $(this).parents('.jpg_modal').find('.preloader').fadeOut();
                }
